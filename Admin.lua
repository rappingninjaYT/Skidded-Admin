...
notif("rapstninja's' Streets admin","took " .. string.format("%.6f",tick()-Tick) .. " seconds\n(Discord: A4nyecN)",10,"rbxassetid://2474242690") -- string.format remains superior - Slays.
notif("Newest Update","dot_mp4 here, rapstninja admin has been completely fixed for the 11/9/20 upd",10,nil)
notif("Source","By Cyrus")
ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Fat","All")
